...
<%
    ...
    pro = proDAO.loadProductById(pId);
%>
<!DOCTYPE html>
<!DOCTYPE html>
<html>
                    ...
                    <div class="register-form">
                        ...
                        <form action="UpdateNewProduct" method="POST">
                            ...
                            <div class="group-input">
                                ...
                                <input type="number" name="price" value="<%=pro.getPrice()%>">
                                <input type="hidden" name="id" value="<%=pId%>">
                            </div>
                            <div class="group-input">
                                <label name="total">total</label>
                                <input type="text" name="total" value="<%=pro.getTotalkilos()%>">
                            </div>
                            <div class="group-input">
                                <label name="imageUrl">Image Name</label>
                                <input type="text" name="imageUrl" value="<%=pro.getImageUrl()%>">
                            </div>
